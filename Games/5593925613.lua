...
if game.PlaceId ~= 5593925613 then return end
...
local flyTog = plrSec:CreateToggle("Player Fly", false, function(bool)
    ...
    if not getgenv().isLoaded then return end
    ...
    if getgenv().settings.fly then
        ...
        function Fly()
            ...
            until not flying or not localPlr.Character:FindFirstChild("Humanoid")
...
infoSec:CreateButton("Most features: BluB#9867", function()
